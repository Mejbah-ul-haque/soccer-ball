...
const Home = () => {
    ...
    return (
        <div>
            <div className='container mx-auto mt-8 grid md:grid-cols-2 grid-cols-1 gap-4 my-4'>
                ...
                <div className=' w-3/4 md:mt-8 mx-auto'>
                    <img className='md:mt-4 rounded-full' src={img} alt="" />
                </div>
            ...
            <div className='container mx-auto'>
                ...
                <button onClick={() => navigate("/reviews")} className='text-2xl bg-green-500 px-16 py-2 rounded-full hover:bg-green-200 hover:font-bold hover:text-green-700 my-10 '>See All Reviews</button>
            </div>
        </div>
    );
};
